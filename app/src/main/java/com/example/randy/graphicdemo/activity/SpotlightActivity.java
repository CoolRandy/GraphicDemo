...
import com.example.randy.graphicdemo.customview.SpotlightView;
...
public class SpotlightActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.spot_light_view);
    ...
    private void createAnimation(final SpotlightView spotlight) {
        ...
        spotlight.setmMaskX(endX);
        spotlight.setmMaskY(startY);
